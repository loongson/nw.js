...
mkdir -p $HOME/nwjs
cd $HOME/nwjs
gclient config --name=src https://github.com/nwjs/chromium.src.git@origin/nw66
git clone -b nw66 https://github.com/nwjs/v8.git src/v8
git clone -b nw66 https://github.com/nwjs/node.git src/third_party/node-nw
git clone -b nw66 https://github.com/loongson/nw.js.git src/content/nw
